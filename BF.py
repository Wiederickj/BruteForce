...
def bruteforce(password, max_nchar=8):
    ...
    print('Test 1) Comparing with most common passwords / first names')
    common_pass = loadtxt('probable-v2-top12000.txt', dtype=str)
    common_names = loadtxt('names.txt', dtype=str)
    ...
    print(' Test 2) Digits cartesian product')
    for l in range(1, 9):
...
'''
    print('Test 3) Digits + ASCII lowercase')
    ...
    print('Test 4) Digits + ASCII lower / upper + punctuation')
...
# EXAMPLE
start = time()
bruteforce(123) # Try with '123456' or '751345' or 'test2018'
end = time()
